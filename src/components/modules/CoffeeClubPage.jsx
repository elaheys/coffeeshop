...
const CoffeeClubPage = () => {
    return (
       <>
       <svg className='hidden'>
        <symbol id='Activity' viewBox="0 0 48 48" fill="#059669" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='mb-8 md:mb-20'>
            <div className='flex flex-wrap lg:flex-nowrap items-center bg-gradient-to-r from-emerald-500 to-emerald-600 text-white 
            gap-y-9 py-8 lg:gap-x-4 xl:gap-x-24 lg:py-0 px-3 lg:px-5 xl:px-11 lg:h-36 rounded-2xl'>
                <div className='flex items-center md:shrink-0 gap-x-3 lg:gap-x-4 xl:gap-x-6'>
                    <img src={diamond} alt='diamond' className='w-[87px] lg:w-[100px] xl:w-[110px]'/>
                    <div>
                ...
                <div className='flex flex-col'>
                    <span className='inline-block md:mb-1 font-DanaDemiBold text-2xl md:text-3xl'>542</span>
                    <span className='text-xs md:text-sm'>امتیـــــــاز شما</span>
                    <a href='#' 
                    className='flex items-center justify-center mt-1 md:mt-2 w-[90px] md:w-[110px] h-[26px] md:h-8 bg-gradient-to-r from-orange-200 to-orange-300
                    font-DanaMedium text-xs md:text-sm rounded-full'>
                        دریافت جایزه
